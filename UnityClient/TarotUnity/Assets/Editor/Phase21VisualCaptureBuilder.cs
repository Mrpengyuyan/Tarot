...
{
    public static class Phase21VisualCaptureBuilder
    {
        public const string ReviewFolder = "Docs/VisualReview/Phase21";
        ...
        [MenuItem("Tools/Tarot Unity/Run Phase 21 Visual Capture")]
        public static void Run()
        {
            if (EditorApplication.isPlaying)
            {
                EditorApplication.isPlaying = false;
                Debug.LogWarning("Exited Play Mode. Run Phase 21 Visual Capture again after Unity returns to Edit Mode.");
                return;
            }
            ...
            Debug.Log("Tarot Unity Phase 21 visual capture complete.");
        }
        ...
        private static void CaptureScene(SceneCaptureTarget target)
        {
            ...
            // Framing proxies show how dealt cards sit in the new composition.
            // They are destroyed after capture and the scene is never saved here.
        ...
        private static List<GameObject> PlaceFramingCards()
        {
            ...
            if (prefab == null)
            {
                Debug.LogWarning($"Phase 21 capture could not load card prefab at {CardPrefabPath}.");
                return proxies;
            }
            ...
            foreach (var slotName in FramingSlotNames)
            {
                ...
                proxy.name = $"Phase21_FramingProxy_{slotName}";
                proxies.Add(proxy);
            }
        ...
        private static void WriteManifest()
        {
            ...
            builder.AppendLine("  ]");
            builder.AppendLine("}");
            File.WriteAllText(Path.Combine(ReviewFolder, "phase21_visual_capture_manifest.json"), builder.ToString());
        }
